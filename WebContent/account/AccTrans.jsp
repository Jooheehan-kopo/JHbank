...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<div class="testbox">
			<form action="<%=request.getContextPath()%>/acctrans.do">
				<h2>JH 조흔은행</h2>
				<!-- ~님 -->
				<div class="item">
					<div class="bank">
					...
					<div class="item">
						...
						<p>이체 금액</p>
						<input type="text" name="trans_money" placeholder="이체할 금액을 입력하세요" />
						<p>계좌번호</p>
						<input type="text" name="send_acc_no" placeholder="상대 계좌를 입력하세요" />
						<p>비밀번호 입력</p>
						<input type="text" name="acc_pw" placeholder="비밀번호를 입력하세요" />
